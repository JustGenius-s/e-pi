...
function MenubarRadioItem({ className, ...props }: React.ComponentProps<typeof MenubarPrimitive.RadioItem>) {
  return (
...
function MenubarCheckboxItem({ className, ...props }: React.ComponentProps<typeof MenubarPrimitive.CheckboxItem>) {
  return (
